...
{{--                            <a href="{{route('nursing-new')}}" class="btn btn-sm btn-primary shadow-sm float-right"><i class="fas fa-plus fa-sm text-white-50"></i> Agregar</a>--}}
                        </div>
                        <div class="card-body">
                            <table class="table table-bordered dataTable">
                                ...
                                @foreach ($nursings as $nursing)
                                    <tr>
                                        ...
                                        <td>{{  $nursing->resident->name }}</td>
                                        <td>{{  $nursing->nursing->name }}</td>
                                        <td><span class="badge badge-success">{{  $nursing->status }}</span></td>
                                        <td>
